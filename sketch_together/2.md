...
Next, go to the `Database` tab on the left-hand side. Scroll down and create a new `Realtime` database for your project. After we're going to select `Rules`. Here we'll set database permissions for reading and writing to `true`.
